...
public class HumanPlayer {
    ...
    public void showCards(HumanPlayer human, ComputerPlayer player1, ComputerPlayer player2, ComputerPlayer player3) {
        ...
        System.out.println(human.name + " has " + human.getScore() + " points in total.");
    	
    	// Prints the visible cards of computer players.
    	System.out.println(player1.name + " has a score of " + player1.getSumOfVisibleCards() + " on the deck.");
    	System.out.println(player2.name + " has a score of " + player2.getSumOfVisibleCards()+ " on the deck.");
    	System.out.println(player3.name + " has a score of " + player3.getSumOfVisibleCards() + " on the deck.");
    }
    ...
    public void takeHiddenCard(int card) {
    	...
    	System.out.println(this.name + " takes a hidden card, which appears to be a " + card);
    }
